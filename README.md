# This is for Myanmar Earthquake Mar 28 2025

### The code is written with the power of AI
This program is for data extraction from json format.

You can use **json url** for data that you'd like to extract.
But you need to modify the property you like to extract in the code.



#### This is for Coordinate Extraction
```
...
#### This is for exporting to csv format
```
